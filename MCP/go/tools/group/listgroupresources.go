...
func ListgroupresourcesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/group/%s/resources%s", cfg.BaseURL, groupIdentifier, queryString)
		...
		var result models.ListGroupResourcesResponse
...
func CreateListgroupresourcesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_group_groupIdentifier_resources",
		mcp.WithDescription("This operation returns a list of the ARNs of the canaries that are associated with the specified group."),
		...
		mcp.WithNumber("MaxResults", mcp.Description("Input parameter: Specify this parameter to limit how many canary ARNs are returned each time you use the <code>ListGroupResources</code> operation. If you omit this parameter, the default of 20 is used.")),
